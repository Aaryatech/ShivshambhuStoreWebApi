...
import com.ats.shiv.model.PoDetail;
import com.ats.shiv.model.indent.DashIndentDetails;
import com.ats.shiv.model.indent.GetIndents;
import com.ats.shiv.model.mrn.GetMrnDetail;
import com.ats.shiv.model.mrn.GetMrnDetailRej;
import com.ats.shiv.model.mrn.GetMrnHeader;
import com.ats.shiv.model.mrn.GetMrnHeaderRej;
import com.ats.shiv.model.mrn.MrnDetail;
import com.ats.shiv.model.mrn.MrnHeader;
import com.ats.shiv.model.mrn.MrnReport;
import com.ats.shiv.model.mrn.PoItemForMrnEdit;
import com.ats.shiv.model.rejection.RejectionMemo;
import com.ats.shiv.model.rejection.RejectionMemoDetail;
import com.ats.shiv.model.rejection.repo.GetMrnDetailRejRepo;
import com.ats.shiv.model.rejection.repo.GetMrnHeaderRejRepo;
import com.ats.shiv.repository.GetItemRepository;
import com.ats.shiv.repository.PoDetailRepository;
import com.ats.shiv.repository.PoHeaderRepository;
import com.ats.shiv.repository.mrn.GetMrnDetailRepository;
import com.ats.shiv.repository.mrn.GetMrnHeaderRepository;
import com.ats.shiv.repository.mrn.MrnDetailRepo;
import com.ats.shiv.repository.mrn.MrnHeaderRepository;
import com.ats.shiv.repository.mrn.MrnReportRepo;
import com.ats.shiv.repository.mrn.PoItemForMrnEditRepo;
...
public class MrnApiController {
	...
	@RequestMapping(value = { "/getMrnDetailBatchForIssue" }, method = RequestMethod.POST)
	public @ResponseBody List<GetMrnDetailRej> getMrnDetailBatchForIssue(@RequestParam("rmId") int rmId) {

		List<GetMrnDetailRej> mrnDetBatchList = new ArrayList<GetMrnDetailRej>();

		try {
				
			mrnDetBatchList = getMrnDetailRejRepo.getMrnDetailForBatchIsuue(rmId);

		} catch (Exception e) {
			System.err.println("Exce in /getMrnDetailBatchForIssue @MRN API ");

			e.printStackTrace();

		}
		return mrnDetBatchList;
