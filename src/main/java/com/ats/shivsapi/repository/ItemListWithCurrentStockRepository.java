...
public interface ItemListWithCurrentStockRepository extends JpaRepository<ItemListWithCurrentStock, Integer> {
	...
	List<ItemListWithCurrentStock> getItemListByCatIdWithStock(@Param("firstDate") String firstDate,
			@Param("fromDate") String fromDate, @Param("toDate") String toDate, @Param("catId") int catId);
	...
	ItemListWithCurrentStock getItemListByItemIdWithStock(@Param("firstDate") String firstDate,
			@Param("fromDate") String fromDate, @Param("toDate") String toDate, @Param("itemId") int itemId);
