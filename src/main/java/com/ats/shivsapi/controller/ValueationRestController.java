...
import com.ats.shivsapi.model.ConsumptionReportData;
import com.ats.shivsapi.model.ConsumptionReportWithCatId;
import com.ats.shivsapi.model.IndentStatusReport;
import com.ats.shivsapi.model.IndentValueLimit;
import com.ats.shivsapi.model.IssueAndMrnGroupWise;
import com.ats.shivsapi.model.IssueAndMrnItemWise;
import com.ats.shivsapi.model.IssueDeptWise;
import com.ats.shivsapi.model.IssueMonthWiseList;
import com.ats.shivsapi.model.ItemQtyWithRecieptNo;
import com.ats.shivsapi.model.ItemValuationList;
import com.ats.shivsapi.model.MonthCategoryWiseMrnReport;
import com.ats.shivsapi.model.MonthItemWiseMrnReport;
import com.ats.shivsapi.model.MonthItemWiseMrnReportRepository;
import com.ats.shivsapi.model.MonthSubDeptWiseIssueReport;
import com.ats.shivsapi.model.MonthWiseIssueReport;
import com.ats.shivsapi.model.MrnMonthWiseList;
import com.ats.shivsapi.model.StockValuationCategoryWise;
import com.ats.shivsapi.model.Type;
import com.ats.shivsapi.model.doc.SubDocument;
import com.ats.shivsapi.repository.ConsumptionReportRepository;
import com.ats.shivsapi.repository.IndentStatusReportRepository;
import com.ats.shivsapi.repository.IndentValueLimitRepository;
import com.ats.shivsapi.repository.IssueAndMrnGroupWiseRepository;
import com.ats.shivsapi.repository.IssueAndMrnItemWiseRepository;
import com.ats.shivsapi.repository.IssueDeptWiseRepository;
import com.ats.shivsapi.repository.ItemQtyWithRecieptNoRepository;
import com.ats.shivsapi.repository.MonthCategoryWiseMrnReportRepository;
import com.ats.shivsapi.repository.MonthSubDeptWiseIssueRepository;
import com.ats.shivsapi.repository.MonthWiseIssueRepository;
import com.ats.shivsapi.repository.StockValuationCategoryWiseRepository;
import com.ats.shivsapi.repository.TypeRepository;
import com.ats.shivsapi.repository.doc.DocumentBeanRepository; 
	...
	public @ResponseBody List<ConsumptionReportWithCatId> getConsumptionData(@RequestParam("fromDate") String fromDate,@RequestParam("toDate") String toDate) {
	 ...
	 @RequestMapping(value = { "/getIndentValueLimit" }, method = RequestMethod.POST)
		public @ResponseBody List<IndentValueLimit> getIndentValueLimit(@RequestParam("fromDate") String fromDate,
				...
				,@RequestParam("status") List<Integer> status,@RequestParam("detailStatus") List<Integer> detailStatus) {

			 List<IndentValueLimit> list = new ArrayList<IndentValueLimit>();
			try {
				 
				 list = indentValueLimitRepository.getIndentValueLimit(fromDate,toDate,typeId,catId,status,detailStatus); 
