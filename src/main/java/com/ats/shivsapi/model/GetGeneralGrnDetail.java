package com.ats.shivsapi.model;
...
@Entity
public class GetGeneralGrnDetail {
	...
	public String toString() {
		return "GetGeneralGrnDetail [grnDetailId=" + grnDetailId + ", grnId=" + grnId + ", itemId=" + itemId
				+ ", grnQty=" + grnQty + ", rate=" + rate + ", approveQty=" + approveQty + ", rejectQty=" + rejectQty
				...
				+ ", itemCode=" + itemCode + ", itemDesc=" + itemDesc + ", catDesc=" + catDesc + "]";
	}
